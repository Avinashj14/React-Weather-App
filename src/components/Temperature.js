...
function Temperature({ initialCity, onCityChange, stats }) {
  ...
  return (
    <>
        ...
        <input  type="text"  className="bg-slate-600 border border-slate-500 text-slate-200 placeholder-slate-400 text-md focus:border-slate-400 block w-60 p-2 focus:outline-none rounded-lg"  placeholder="Enter Your City Name"  
          onChange={handleInputChange} />
        <div className="m-4" onClick={handleSearch} >
